        ...
        return (
            <div className="select-data-main">
                ...
                <div className="doc-box">
                    ...
                    <div className="check-agree">
                        <label htmlFor="AgreeChk">
                            <input onClick={e => this.setState({ agreeRisk: e.target.checked })} type="checkbox" />
                ...
                <div className="check-pwd">
                    <div>請再次輸入密碼</div>
                    <div>
                        <input onChange={e => this.setState({ pwdAgain: e.target.value })} type="password" />
                    </div>
                </div>
